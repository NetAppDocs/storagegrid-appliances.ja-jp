...
---
= Grid Managerを使用してSG6100ストレージコントローラのSANtricity OSをアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SANtricity OS 08.42.20.00（11.42）以降を現在使用しているストレージコントローラでは、Grid Managerまたはメンテナンスモードを使用してアップグレードを適用できます。
