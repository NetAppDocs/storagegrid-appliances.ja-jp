...
---
= Grid Managerを使用してSG6160ストレージコントローラのSANtricity OSをアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["メンテナンスモードを使用したSG6160コントローラのSANtricity OSのアップグレード"]
