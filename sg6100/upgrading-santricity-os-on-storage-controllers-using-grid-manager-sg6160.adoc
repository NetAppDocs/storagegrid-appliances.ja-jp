...
summary: アップグレードを適用するには、Grid Managerまたはメンテナンスモードを使用できます。 
---
= Grid Managerを使用してSG6160ストレージコントローラ上のSANtricity OSをアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["メンテナンスモードを使用したSG6100コントローラのSANtricity OSのアップグレード"]
