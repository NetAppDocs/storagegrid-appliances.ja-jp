...
---
= StorageGRID アプライアンスでBMC管理ポートのIPアドレスを設定する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_bmc_management_port.png[BMC管理ポートSG120]
...
.SG1200
--
image::../media/sg1200_bmc_management_port.png[BMC管理ポートSG1200]
...
image::../media/sgf6212_bmc_management_port.png[BMC管理ポートSGF6212]

_SG6200-CN_：

image::../media/sg6200_cn_bmc_management_port.png[BMC管理ポートSG6200-CN]
...
. LAN IP 設定で、自動的に表示される IPv4 アドレスをメモします。
+
