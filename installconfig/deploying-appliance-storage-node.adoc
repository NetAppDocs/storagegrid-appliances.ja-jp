...
---
= StorageGRIDアプライアンスストレージノードを導入する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.次の手順
link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["グリッドの設定とインストールの完了"^]とlink:monitoring-appliance-installation.html["アプライアンスのインストールの監視"]について学ぶ。
