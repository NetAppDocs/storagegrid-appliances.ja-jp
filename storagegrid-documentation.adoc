...
[role="lead"]
へ移動 https://docs.netapp.com/us-en/storagegrid/index.html["StorageGRID 12.0 ドキュメント"^]StorageGRID 12.0 システムの構成方法と使用方法を学習します。
...
* https://docs.netapp.com/us-en/storagegrid-119/index.html["StorageGRID 11.9ドキュメント"^]
