...
summary: Grid Manager を使用してアップグレードを適用できます。 
---
= Grid Manager を使用した SG5800 ストレージコントローラ上の SANtricity OS のアップグレード
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Grid Managerを使用してアップグレードを適用できます。また、link:upgrading-santricity-os-on-storage-controller.html["メンテナンスモードを使用してアップグレードを適用する"]。
